...
public enum ParticleEffect {
	...
	/**
	 * A particle effect which is displayed by dragon breath on the ground:
	 * <ul>
	 ...
	 * <ul>
	 * <li>It looks like a white circle that changes into a diamond shape
	 * </ul>
	 */
	END_ROD("endRod", 43, 9),
	/**
	 * A particle effect which is displayed when a mob is hurt:
	 * <ul>
	 * <li>It looks like an off shade dark red heart
	 * </ul>
	 */
	DAMAGE_INDICATOR("damageIndicator", 44, 9),
	/**
	 * A particle effect which is displayed when using a sword sweep attack:
	 * <ul>
	 * <li>It looks like a swipe motion
	 * <li>The speed value has no influence on this particle effect
	 * </ul>
	 */
